...
describe OrdersController do
  ...
  let(:valid_attributes) { { "date" => "2013-05-25" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested order" do
        ...
        Order.any_instance.should_receive(:update_attributes).with({ "date" => "2013-05-25" })
        put :update, {:id => order.to_param, :order => { "date" => "2013-05-25" }}, valid_session
      end
